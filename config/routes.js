...
apiRouter.get("/v1/Notif", controllers.api.v1.notifController.Notif);
apiRouter.get("/v1/NotifUser/:id", controllers.api.v1.notifController.NotifUser);
...
apiRouter.get("/v1/Produk/:id/:jenis", controllers.api.v1.productController.jenis);
apiRouter.delete(
    "/v1/produk/delete/:id",
    controllers.api.v1.productController.deleteProduct
);
apiRouter.get("/api/v1/penjualan/:id", controllers.api.v1.penjualanController.list);
apiRouter.get("/api/v1/pembelian/:id", controllers.api.v1.penjualanController.listPembelian);
...
apiRouter.post("/api/v1/wishlist/add", controllers.api.v1.wishlistController.createWishlist);
apiRouter.get("/api/v1/wishlist/buyer/:id/", controllers.api.v1.wishlistController.getWishlistBuyer);
apiRouter.delete("/delete/:id/:idp", controllers.api.v1.wishlistController.deleteWishlist);

apiRouter.get("/wishlist/:id/:idp", controllers.api.v1.wishlistController.getWishlist);
apiRouter.get("/wish", controllers.api.v1.wishlistController.semua);
